...
The driver is intended to be used with the included `sensor.py` example. Make sure to upload both the driver file and `sensor.py` to your Pico before running the example.
